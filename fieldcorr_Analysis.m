...
%       significance level.
%
%   areSigM: A logical indicating whether each lagged correlation maintains
%       significance given multiple comparisons.
%
%   nNeededM: The number of tests that each lagged correlation must pass in
%       order to maintain significance at the desired significance level.
%
%   areSigS: A logical indicating whether each lagged correlation maintains
%       significance at each significance level given spatial
%       interdependence.
%
...
%
%   areSig: Indicates whether a set of lagged p-values maintain
%       significance at a significance level after considering all 
